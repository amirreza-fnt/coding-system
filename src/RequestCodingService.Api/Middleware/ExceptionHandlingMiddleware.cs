...
namespace RequestCodingService.Api.Middleware;
...
public sealed class ExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (CounterExhaustedException ex)
        {
            await WriteErrorAsync(context, StatusCodes.Status409Conflict, "COUNTER_EXHAUSTED", ex.Message, traceId);
        }
